...
import { Home, Palette, LayoutGrid, PaintBucket, RefreshCcw, MessageSquare, HelpCircle } from 'lucide-react';
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-ochre/10 flex items-center justify-center mb-6 group-hover:bg-ochre transition-colors duration-300">
                  <IconComponent className="w-6 h-6 text-ochre group-hover:text-white transition-colors duration-300" />
                </div>
